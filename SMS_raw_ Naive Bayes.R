...
#Load the SMS raw data set or Import the data set in global environment 
sms_raw <- read.csv("C:\\Users\\KIIT\\Desktop\\assignment2021\\Data Science Assignment_LeepsaMahankud\\Naive Bayes\\sms_raw_NB.csv", stringsAsFactors = FALSE)
