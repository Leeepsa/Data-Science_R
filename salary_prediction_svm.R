...
salary_train <- read.csv("C:\\Users\\KIIT\\Desktop\\assignment2021\\Data Science Assignment_LeepsaMahankud\\Naive Bayes\\SalaryData_Train.csv")
str(salary_train)

salary_test <- read.csv("C:\\Users\\KIIT\\Desktop\\assignment2021\\Data Science Assignment_LeepsaMahankud\\Naive Bayes\\SalaryData_Test.csv")
str(salary_test)
