...
##Load  the LabTAT data set or Import the LabTAT data set in global environment 
LabTAT <- read.csv("E:\\Excel-R Assignments & Other Data\\Assignment\\Hypothesis Testing\\LabTAT.csv")
...
# As per reveived  P value <2e-16(2.2 X 10 ^-16) which is less than 0.05 
...
# we can say that labroratories 1 & Lab 2 avaerage TAT reports are different from 
# labroratories 3 & labroratories 4. 
# Also all 4 labraotories average TAT reports are different from each other as per box plot
# observation at few points. 
# Laboratory 1 & 4 TAT average reports have outaliers in upper & lower extreme 
