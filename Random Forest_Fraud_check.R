...
##Load the data
fraud_check <- read.csv("C:\\Users\\KIIT\\Desktop\\assignment2021\\Data Science Assignment_LeepsaMahankud\\Random Forests\\Fraud_check.csv")
...
##Convert charcter varaible into numerical 
