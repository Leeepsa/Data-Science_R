...
salary_train <- read.csv("C:\\Users\\KIIT\\Desktop\\assignment2021\\Data Science Assignment_LeepsaMahankud\\Naive Bayes\\SalaryData_Train.csv",stringsAsFactors = FALSE)

salary_test <- read.csv("C:\\Users\\KIIT\\Desktop\\assignment2021\\Data Science Assignment_LeepsaMahankud\\Naive Bayes\\SalaryData_Test.csv",stringsAsFactors = FALSE)

# Cheking the class imbalance 
