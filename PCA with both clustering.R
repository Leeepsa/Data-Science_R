...
##component scores (both heirarchial and k mean clustering(scree plot or elbow curve) and obtain
##optimum number of clusters and check whether we have obtained same number of clusters with the 
##original data(class column we have ignored at the begining who shows it has 3 clusters)df
  
##Load the data 
wine <- read.csv("C:\\Users\\KIIT\\Desktop\\assignment2021\\Data Science Assignment_LeepsaMahankud\\PCA\\wine.csv")

##Standarization of data 
wine_std <- scale(wine[,c(2:14)])

##Finding direction of variance through correlation or covaraince matrix function 
...
##Visualtion of 3 scores of data 
library(lattice)
...
#           means that PCA + Hirerarical clustering & PCA + K means clustering
#           due to 1st 3 PCA scores data "wine_nd" is using in both clustring. 
