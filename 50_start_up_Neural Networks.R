...
#Load the 50_start_up data or Import the data set in global environment  
fifty_start_up <- read.csv("C:\\Users\\KIIT\\Desktop\\assignment2021\\Data Science Assignment_LeepsaMahankud\\Neural Networks\\50_Startups.csv")
