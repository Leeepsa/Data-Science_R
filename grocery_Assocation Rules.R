...
############Prepare Asssociation rules for grocery data ##########################

##Load the tha data 
grocery <- read.csv("C:\\Users\\KIIT\\Desktop\\assignment2021\\Data Science Assignment_LeepsaMahankud\\Association Rules\\groceries.csv")
