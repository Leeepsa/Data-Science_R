...
#Load the data
Glass <- read.csv("C:\\Users\\KIIT\\Desktop\\assignment2021\\Data Science Assignment_LeepsaMahankud\\KNN\\glass.csv")
...
# Cheking & removing the duplicay in data 
library(dplyr)
...
#standarize the feature of data 
