...
############Prepare Asssociation rules for my movies data ##########################

##Load the tha data 
mymovies <- read.csv("C:\\Users\\KIIT\\Desktop\\assignment2021\\Data Science Assignment_LeepsaMahankud\\Association Rules\\my_movies.csv")
...
##Rules with rhs containing pipleline "V3" movies 
