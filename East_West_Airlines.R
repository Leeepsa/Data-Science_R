...
###Load the data 
EastWestAirlines <- read_excel("import dataset excel file in global environment ")
...
## divided 3999 paasanger into 5 clusters as per their similar chartristics with their Id's. 
...
###Load the data 
library(readxl)
EastWestAirlines <- read_excel("C:\\Users\\KIIT\\Desktop\\assignment2021\\Data Science Assignment_LeepsaMahankud\\Clustering\\EastWestAirlines.xlsx")
