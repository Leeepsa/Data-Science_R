...
############ Forecast the Airlines Paasangers for next 12months ############

##Load the data and view
install.packages("readxl")
library(readxl)
Airlines_Data <- read_xlsx("C:\\Users\\KIIT\\Desktop\\assignment2021\\Data Science Assignment_LeepsaMahankud\\Forecasting\\Airlines+Data.xlsx")
...
# By principal of parcimony we will consider 3-lags  as we have so 
...
#Cheking the resduals of model 
acf(model_AA$residuals)
## Forcasting the pessanger travelled for next 12month 
windows()
