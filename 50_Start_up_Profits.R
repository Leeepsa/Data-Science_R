...
#Load data
fifty_start_up <- read.csv('C:\\Users\\KIIT\\Desktop\\assignment2021\\Data Science Assignment_LeepsaMahankud\\Multi Linear Regression\\50_Startups.csv')
...
##1st Iteration 
#Tranformation of data input varaiable
