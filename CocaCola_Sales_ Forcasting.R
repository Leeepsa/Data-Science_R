...
#Import cocacola sales data set in Global enviornment 
...
library(readxl)
CocaCola_Sales_Rawdata <- read_xlsx("C:\\Users\\KIIT\\Desktop\\assignment2021\\Data Science Assignment_LeepsaMahankud\\Forecasting\\CocaCola_Sales_Rawdata.xlsx")
