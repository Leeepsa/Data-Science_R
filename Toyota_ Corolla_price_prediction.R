...
##Load the data or import Toyota Corolla data set in global environment 
toyota_r<-read.csv("C:\\Users\\KIIT\\Desktop\\assignment2021\\Data Science Assignment_LeepsaMahankud\\Multi Linear Regression\\ToyotaCorolla.csv")
