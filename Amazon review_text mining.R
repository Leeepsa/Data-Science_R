...
############ Amazon review extract by Text Mining ############
...
#apple <- read.csv("E:\\DATASCIENCE\\2nd May Data Science Class\\Assignment_2020\Data Science Assignment_Rahul_ Goswami\\Text Mining\\apple.txt", sep="")
# Importing apple reviews data
...
#Spliting sentences into words for each corpus 
x1 <- tokenize_words(amazon_reviews)
x1[1]
