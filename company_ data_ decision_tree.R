...
##Load the data 
company_data <- read.csv("C:\\Users\\KIIT\\Desktop\\assignment2021\\Data Science Assignment_LeepsaMahankud\\Decision Trees\\Company_Data.csv")

## EDA process
##Catagorised the class variable 
...
##Convert class varaiable into character to factor 
