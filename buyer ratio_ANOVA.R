...
##Load the data or Import the buyer ratio data set in global environment  
BuyerRatio <- read.csv("E:\\Excel-R Assignments & Other Data\\Assignment\\Hypothesis Testing\\BuyerRatio.csv")
...
# As per recevied value of P 0.82 which is greater than 0.05 then we reject null hypothesis. 
