...
## Load the data 
credit_card <- read.csv('E:\\Excel-R Assignments & Other Data\\Assignment\\Logistic Regression\\creditcard.csv')


## Covert catagorical variable levels   into into numeric values    
