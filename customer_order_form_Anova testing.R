...
## Import the buyer ratio data set in global environment
CustomerOrderForm <- read.csv("Import the buyer ratio data set in global environment")

## ANOVA for finding defectivness % in customer order forms in four countries 
...
## defectivness from its center due to each indivisual tell Call center customer order form 
...
## TellCall center customer order form defectivness from its center.
## As per summary of all country tellcall center each center customer order forms have 
## few % of deffectivness from its center which details are following:
## phillippines customer order forms: 9.67%  defectiveness &  90.33% error free   
## Indonesia customer order forms:    11%    deffectivness &  89%    error free
## Malta customer order forms:        10.33% deffectivness &  89.67% error free
## India customer order forms:        6.67%  deffectivness &  93.33  error free
