...
##Load the data
fraud_check <- read.csv("C:\\Users\\KIIT\\Desktop\\assignment2021\\Data Science Assignment_LeepsaMahankud\\Decision Trees\\Fraud_check.csv")
...
##Convert charcter varaible into factor 
...
################# Boosting Method
##Load the data
fraud_check <- read.csv("E:\\Excel-R Assignments & Other Data\\Assignment\\Decision Trees\\Fraud_check.csv")
